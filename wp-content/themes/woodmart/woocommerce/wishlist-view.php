                    ...
                    <tr id="yith-wcwl-row-<?php echo esc_attr( $item['prod_id'] ); ?>" data-row-id="<?php echo esc_attr( $item['prod_id'] ); ?>">
                        ...
                        <?php if( $show_price ) : ?>
                            <td class="product-price" data-title="<?php esc_attr_e( 'Unit Price', 'yith-woocommerce-wishlist' ); ?>">
                                <?php echo true == $product->get_price() ? $product->get_price_html() : apply_filters( 'yith_free_text', __( 'Free!', 'yith-woocommerce-wishlist' ) ); ?>
                            </td>
                        <?php endif ?>

                        <?php if( $show_stock_status ) : ?>
                            <td class="product-stock-status" data-title="<?php esc_attr_e( 'Stock Status', 'yith-woocommerce-wishlist' ); ?>">
                                <?php echo 'out-of-stock' === $stock_status ? '<span class="wishlist-out-of-stock">' . __( 'Out of Stock', 'yith-woocommerce-wishlist' ) . '</span>' : '<span class="wishlist-in-stock">' . __( 'In Stock', 'yith-woocommerce-wishlist' ) . '</span>'; ?>
                            </td>
                        <?php endif ?>
